...
% consumption is critical for many reasons.
...
\begin{figure}[H]
 ...
 \caption{Happiness against GDP, total energy use, and energy intensity of GDP. For average electricity consumption per electrified
   ...
   in supplementary material.}\label{couWvsLsEnePerGdp2} %couWvsLsEnePerGdp2 doesn't have
...
%TODO!!! if electricity across states then clarify there!; if not then move this
%to CA only! 
%
...
\caption{Happiness and total residential electricity consumption across US states and  
  California counties.  %TODO!!!!!check if for states it is electricity!!! i
                        %guess it is total energy instead!!!BUG?????
...
Happiness and total energy consumption
  ...
  unsmoothened series) %TODO!!!!!!!!!! meh do for somoothened!!! onless very big!!!!
