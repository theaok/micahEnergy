...
\caption{and over time no relationship either ! correlation is .2 only (for
  unsmoothened series) for unsmotthened happipiness see fig \ref{cenDivLsYr} on p \pageref{cenDivLsYr}}\label{cenDivLsYrSm}
\end{figure}
