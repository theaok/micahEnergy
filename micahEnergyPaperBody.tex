...
resurce depletion and pollution. Yet, it is difficult to argue reductions
...
translates into  little happiness or may even decrase it depending on level
...
science and to society today. Energy consumption is an important, if not
...
Energy use has, of course, many benefits as well. We know that pollution makes
us unhappy \cite{mackerron09,gandelman12,ferreira13}. % TODO check these
...
Product and its variations--per capita and Purchising Power Parity
adjuested--have been used to evaluate development. Human Development Index (HDI)
added life expectancy and education, but more recently a co-inventor of HDI,
Amartya Sen, has poropsed happiness as better measure of development
\cite{stiglitz09al}. It is striking, that there were only two direct attempts to
relate energy consumption to happiness. One early study in 70s proxied 
 measured happiness indirectyly bu usung a set of indicator in a small
 cross-national sample \cite{mazur74}, and the second study is a recent master
 theis that used happiness measure directly also across nations \cite{winfrey13}, but neither
 study  thinks of energy intensity of GDP, nor explores variation at finer geographic representation thatn a country.

Furthermore, energy is a strategic resource--many wars were fought over energy and much of politics is driven by it.
...
societal energy consumption and indivdual self-interest--substantially reducing
...
data on energy consumption and on life satisifaction we find that  the
relationship is weak. % , with exception of poor countries, where more energy is% nneded for greater happiness.
...
Results suggests that the energy consumption can be substantially reduced,
without making people less happy.  We discuss the possible underlying causes for
...
Energy consumption matters beyond happiness. Countries wage wars about energy sources. Many
countries' whole economies depend on energy exports (e.g. OPEC
...
factor of 10 in affluent societies  as advocated by \cite{pretty13}. This,
...
Inughuit, most people are above neutral in well-being.

%AOK: SEE OTHER PNAS IF MECHANISMS GO BEFORE RESULTS!!
What is the mechanism? Why energy consumption is not likely to buy much
hppiness?  There are several psychological explnataions about causal pathways.
...
falls) does not result in lasting happiness as opposed to experiece
...
high in happiness such as gardening or yoga \cite{madjar06}. Then, there is
often consumption arms race--people trying to oucompete each other in
consumption but not finding much happiness after all\cite{frank12}.% MAYBE hedonic adaptation etc etc
...
\textbf{Basic Cross-Sectional Relationships.} We start with simple bivariate cross-sectional relationship at country level. % --there is not much variation in happiness over
...
Total energy  consumption comes from the World Bank
...
Data are plotted in figure \ref{couWvsLsEnePerGdp2}. We know that across
 ...
 surprisng. But, perhaps surprisingly,  we find that the relationship flips to
 negative, when we measure energy as use efficiency.  The second panel
 ...
 do not necessarily need to increase GDP keeping energy constant; we could
 decrease energy use insetead, as already argued  in 70s \cite{mazur74}. While the Netherlands (NLD) is
 rich,  energy efficient and happy, Columbia is also happy and energy efficient,
 but poor.  
...
their GDP and have simialr energy inetsity of GDP as the US. Notably, in the
first panel they all
cluster in the top left--the point is that great happiness is possible using not
much energy. On the other hand,  East European, post-Soviet countries cluster at
bottom left.   
Next, we zoom in on
...
While more income and sometimes more energy is beneficial for human happiness in
poor countries, in rich countries, it is likely that not only we do not need
...
\cite{kallis11,kallis12,bergh11}. We will focus now on the US trying to answer
...
and it is growing fast %winfrey13 p7
 ;  
and we also now focus on personal energy use.
...
how satisfied are you with your life?'' just the scale is narrower and ranges
...
consumption per capita in the residential sector, m BTU.'' Green California has
Energy Consumption Data Management System
(\url{http://www.ecdms.energy.ca.gov/elecbycounty.aspx}), which provided
residential electricity consumption per capita used here.  Results are shown in
figure \ref{stateCa}. Energy-hungry states (with possible exception of transportation sector) are no happier% --this is just another argument for energy conservation
. There are two outliers, Hawaii and California consuming much less energy in
the residential sector than others. Then we zoom in on California counties in
...
We have also experimented with energy inetsity of
GDP on x-axis and the picture was similar (see supplementary material figures
XXX). And we do not spend any less in the US on energy--5-10\% of personal
expenditure goes on energy over past 50 years, and if anything it increased over
...
\caption{Happiness and residential electricity use across US states and
...
cross-section, but not in time series \cite{easterlin74,easterlin12}. We supplement our cross-setional explorations with a
look over time. 
...
\begin{figure}[H]
 \includegraphics[width=6in]{graphsAndTables/cenDivLsYrSm.pdf}\centering
\caption{6-year moving average smoothened happiness and total energy consumption
  in residential sector. Correlation is .2 only (for
  unsmoothened series) for unsmotthened happipiness see fig \ref{cenDivLsYr} on
...
to socitty of conservers, we won't suffer much in terms of
happiness. While in poorest countries, more income income and often more energy
are needed to increase happiness; in developed world, we arguably could  decrease
energy use without much loss in happiness. % can alse give some numbers on how much energy uses an american v
            % chinese etc
Do Indians and Chinese need to consume more energy? Yes. But not Americans, and
Texans could consume as much as Californians and no tradegy would
happen. Furthermore it is unfair for the develop world to lecture developing
countries about enegry conservation without first making very substantial cuts
at home.
