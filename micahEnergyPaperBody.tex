...
We find instead that national well-being is moderately associated with the energy intensity of GDP. Although not a necessary condition for well-being, countries that efficiently convert energy to economic productivity, may benefit from increased energy use up to a point. 
...
Even this simple figure reveals some puzzles: Although the relationship between well-being generally increases with energy consumption -- the variance across countries is tremendous. Further, some countries with high energy use, such as Russia and Estonia have low overall well being, the highest energy users do are not the most well-off overall, and many countries such as Columbia, Guatemala and Mexico are able to reach the highest level of subjective well-being while maintaining very low energy use. Why should this be?

% 4/13
% TODO 
%
% Fig 1a - graphical emphasize high well-being/low energy countries
% Fig 1a - do we really believe Mex, Guatemal and Columbia have higher well-being -- seems like WVS may be incompletely
%		   measuring this
...
In a descriptive sense, high energy intensity indicates that a country requires a high cost to converting energy into GDP. Another way to put this is that some countries are more efficient (in the economic, not technical sense) at converting energy into wealth. 

There are a number of possible causal explanations for this difference in economic efficiency. One possible cause is the use of more energy-efficient technologies -- these technologies reduce energy inputs for the same output of goods. Use of energy efficient technologies would yield economic gains at the national level, if the total cost of energy (includin) is sufficiently high -- and might not be chosen at the individual level if those costs included interpersonal externalitie, such as polition. 
...
%	 - what type of observation would be needed to test them
