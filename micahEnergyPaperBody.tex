...
energy problem \cite{mackay08}. For instance, 98 \% of US emissions are due to
energy consumption \cite{eia08}. Despite
...
used to evaluate development \cite{jorgenson14C}. Human Development Index (HDI)
...
wellbeing will 
suffer \cite{gordon_wsj_may_29_14, dietz15, carter_pbs_apr_18_77,smil05}. %kenny_businessweek_aug_29_14, 
...
well-being \cite{mazur11, jorgenson14C}: How does the relationship between
energy use and happiness change if we take economic deveopment into account?
% 4/13
...
\begin{figure}[H]
 \includegraphics[width=6in]{graphsAndTables/couWdhEneGdp.pdf}\centering \caption{Happiness
   against per capita energy use (first panel), and energy intensity of GDP
   (second panel). Quadratic fit shown with 95\%
...
positive. This discrepancy between expectation and experience is illustrated
...
\cite{kahneman97ws}. Humans also tend to be wrong in their perceptions of energy
consumption and savings \cite{attari10,dietz14B}. 
...
in the US is nil. % --poor countries need to consume more enrgy in order to increase their
...
suggested that conspicuous or wasteful consumption does not make us any happier  \cite{csikszentmihalyi99, frank04, frank05, frank12}, but few actually test it.
...
already substantial consumption does not buy much happiness, if any. Just as increasing  income
 ...
 curb consumption have been suggested \cite{dietz14B,dietz15,asensio15, dumas87,attari10}.
...
urban or dense areas are less happy \cite{aokCityBook15} and more energy
efficient \cite{meyer13}, and hence
