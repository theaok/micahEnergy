...
resource--many wars were thought over energy and much politics is about.
...
\begin{figure}[H]
 ...
 \caption{WVS all countries, avergaed over time; this is residential ene consumption; received wisdom is that richer countries are happier and those are countries that consume more energy, but if we lookk at energy intesity of gdp, it i sstrongly negative! }\label{couWvsLsEleHHgdp}
\end{figure}
...
\caption{and over time no relationship either ! for unsmotthened happipiness see fig \ref{cenDivLsYr} on p \pageref{cenDivLsYr}}\label{cenDivLsYrSm}
 \end{figure}
...
\caption{driving is good in california s well ! (left electrisity; right gas)}\label{cenDivLsYrMGAPB}
 \end{figure}


\newpage
\section{\huge OLD/OTHER STUFF} initially in another document: graphsAndTables.tex
...
\begin{table}[H]\centering \caption{ols1} \label{ols1} \begin{scriptsize} \begin{tabular}{p{1.4in}p{.43in}p{.43in}p{.43in}p{.43in}p{.43in}p{.43in}p{.43in}p{.43in}p{.43in}p{.43 in}p{.43in}p{.43 in}}\hline \input{/tmp/ls_en/ols1.tex} \hline\multicolumn{6}{l}{+p$<$0.10 *p$<$0.05 **p$<$0.01 ***p$<$0.001; robust standard errors} \end{tabular}\end{scriptsize}\end{table}
