...
Please find enclosed a manuscript entitled ``Energy Use And Happiness''
 authored by Adam Okulicz-Kozaryn% coauthored by Adam
% Okulicz-Kozaryn and Micah Altman
, for consideration for publication in PNAS. 
...
of the most fundamental types of consumption and has an enormous effect on our
lives. % , which we take for granted in the developed world
% .  At the same time, 
%  most of energy still uses up nonrenewable fossil fuels and pollutes.
 A key
 barrier to energy conservation is widely held belief that reduction in energy
 consumption will adversely affect wellbeing. We add one more argument for
 energy conservation--in developed countries, energy use and happiness have a nil relationship. \\    
